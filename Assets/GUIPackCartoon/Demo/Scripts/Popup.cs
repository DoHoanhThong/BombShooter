...
namespace Ricimi
{
    ...
    {
        public static System.Action OnOpenPopup;
        public static System.Action OnClosePopup;

        public Color backgroundColor = new Color(10.0f / 255.0f, 10.0f / 255.0f, 10.0f / 255.0f, 0.6f);
        [SerializeField] TMP_Text _timeBonus; 
        ...
        //void SetTime()
        //{
        //    _timeBonus.text = "+" + PlayerPrefs.GetInt("Time_up").ToString() + "s";
        //}
